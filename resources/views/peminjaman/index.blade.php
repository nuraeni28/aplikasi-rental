        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    ...
                    @endif
                        <h4 class="mt-0 header-title">Data Peminjaman</h4>
                         ...
                         <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                             <div class="modal-dialog" role="document">
                                 <div class="modal-content">
                                     ...
                                     <form action="{{ route('peminjaman.create') }}" method="POST" enctype="multipart/form-data">
                                         @csrf
                                         <div class="modal-body">
                                             <div class="form-group">
                                                 <label for="judul">Tanggal Mulai</label>
                                                 <input type="date" name="mulai" class="form-control" placeholder="Tanggal Mulai">
                                             </div>
                                             <div class="form-group">
                                                <label for="model">Tanggal Selesai</label>
                                                <input type="date" name="selesai" class="form-control"  placeholder="Tanggal Selesai">
                                            </div>
                                            <div class="form-group">
                                                <label for="matkul">mobil</label>
                                                <select name="mobil" id="no_plat" class="form-control">
                                                    <option >pilih mobil</option>
                                                    @foreach($mobil as $mobilItem)
                                                        <option value="{{ $mobilItem->id }}">{{ $mobilItem->nomor_plat }} - {{ $mobilItem->model }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form id="deleteForm" method="POST" action="{{ route('peminjaman.delete',$data->id) }}">
                    @csrf
                    @method('Delete')
